...
export default function Home() {
  ...
  return (
    <>
      <head>
        <title>AI Beauty Test | Check Your Attractiveness Score 1-10 | Facial Analysis</title>
        <meta name="description" content="Discover your beauty score with our AI Beauty Test. Upload a photo for instant analysis of your facial features and get a 1-10 attractiveness rating with personalized enhancement tips." />
        <meta name="keywords" content="AI beauty test, attractiveness score, face rating, beauty analysis, facial attractiveness, AI face score, facial symmetry, beauty enhancement, facial features evaluation" />
        <meta property="og:title" content="AI Beauty Test | Check Your Attractiveness Score" />
        <meta property="og:description" content="Use AI technology to analyze your facial features and get a 1-10 attractiveness score with personalized tips." />
        <meta property="og:image" content="/og-image.jpg" />
        <meta property="og:url" content="https://ai-beauty-test.com" />
        <meta property="og:type" content="website" />
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="AI Beauty Test | Facial Attractiveness Analysis" />
        <meta name="twitter:description" content="Analyze your facial features with AI and get an objective attractiveness score." />
        <meta name="twitter:image" content="/og-image.jpg" />
        <link rel="canonical" href="https://ai-beauty-test.com" />
        ...
        <div className="min-h-screen flex flex-col bg-white">
          ...
          <header className="border-b border-gray-100 py-4">
            <div className="container mx-auto px-4 flex justify-between items-center">
              <div className="text-2xl font-bold text-blue-500">AI Beauty Test</div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                ...
                <div>
                  ...
                  <ul className="space-y-2">
                    ...
                    <li><a href="#" className="text-gray-500 hover:text-blue-500">Terms of Service</a></li>
                    <li><a href="#" className="text-gray-500 hover:text-blue-500">Cookie Policy</a></li>
                    <li><a href="#" className="text-gray-500 hover:text-blue-500">GDPR Compliance</a></li>
                  </ul>
                </div>
